...
CREATE TABLE `t_permission` (
  ...
  CONSTRAINT `FKj5677vunybnban0afgm7069l2` FOREIGN KEY (`role_id`) REFERENCES `t_role` (`id`)
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('1', 'tom', '123456', '1', '16');
INSERT INTO `t_user` VALUES ('2', 'jack', '123456', '2', '13');
INSERT INTO `t_user` VALUES ('3', 'rose', '123456', '2', '18');
